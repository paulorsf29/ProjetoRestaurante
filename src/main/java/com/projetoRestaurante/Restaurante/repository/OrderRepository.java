...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    List<Order> findTop5ByCustomerIdOrderByCreatedAtDesc(@Param("customerId") UUID customerId);
    ...
    boolean existsByCustomerIdAndItems_MenuItemIdAndOrderStatus(UUID customerId, UUID menuItemId, Order.OrderStatus status);
    ...
    boolean existsByCustomerIdAndMenuItemId(@Param("customerId") UUID customerId, @Param("menuItemId") UUID menuItemId
    );
}
